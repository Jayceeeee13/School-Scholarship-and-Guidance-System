{{-- resources/views/filament/pages/exam-result-slip.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>Result Slip – {{ $record->user->name ?? 'Unknown Examinee' }}</title>
<style>
...
<div class="sheet">
  ...
  <div class="slip">
    ...
    {{-- Small header: logo | name+address / title --}}
    ...
    <div class="content-box">
      @include('filament.pages.partials.result-slip-body', $slipData)
    </div>
