...
class InstitutionalScholarsImport implements ToModel, WithStartRow, WithValidation, SkipsOnError, SkipsOnFailure
{
    ...
    public function model(array $row)
    {
        ...
        $existsInDb = InstitutionalScholar::where('term_id', $this->termId)
        ...
        return new InstitutionalScholar([
            'term_id'             => $this->termId,
            'student_id'          => $studentId,
            'last_name'           => $lastName,
