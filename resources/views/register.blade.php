    ...
    <div class="relative max-w-6xl mx-auto px-6 py-12 grid gap-10 lg:grid-cols-[minmax(0,1.2fr),minmax(0,1fr)] items-start">
        ...
        <div class="w-full max-w-md ml-auto bg-white/95 backdrop-blur rounded-2xl shadow-xl shadow-emerald-950/40 border border-emerald-200/70 p-6 md:p-8">
            ...
            <form method="POST" action="{{ route('register.post') }}" class="space-y-4">
                @csrf
                <input type="hidden" name="enrollment_type" id="enrollment_type" value="{{ old('enrollment_type', 'enrolled') }}">
                ...
                <div id="fields-enrolled" class="fields-section space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="last_name_enrolled" value="{{ old('last_name_enrolled') }}"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="date" name="birthdate_enrolled" value="{{ old('birthdate_enrolled') }}"
                               class="block w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none">
                    </div>
                ...
                <div id="fields-unenrolled" class="fields-section space-y-4 hidden">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text"
                               ...
                               class="block w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none @error('contact_no') border-red-400 @enderror">
                        @error('contact_no')
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text"
                               ...
                               class="block w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none @error('address') border-red-400 @enderror">
                        @error('address')
                            <p class="text-xs text-red-500 mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="space-y-1.5">
                        <label class="block text-sm font-medium text-slate-700">Email <span class="text-red-400">*</span></label>
                        <input type="email" name="email_unenrolled" value="{{ old('email_unenrolled') }}"
                               class="block w-full rounded-lg border border-slate-300 px-3 py-2.5 text-sm shadow-sm focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none">
                    </div>
...
<script>
    ...
    const oldType = '{{ old('enrollment_type', 'enrolled') }}';
