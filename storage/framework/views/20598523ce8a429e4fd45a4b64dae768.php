...
<header class="bg-green-800 border-b border-white sticky top-0 z-50 shadow-sm shadow-green-900/5">
    <div class="max-w-8xl mx-auto px-6 py-3 flex flex-wrap justify-between items-center gap-4">
        ...
        <a href="<?php echo e(url('/gvc')); ?>" class="flex items-center gap-2 flex-shrink-0">
            <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Green Valley College Foundation"
            ...
            <?php else: ?>
                ...
                <div class="relative"
                     x-data="{
                         ...
                         notifications: <?php echo e(Js::from($notifications)); ?>,
                    ...
                    >
                        ...
                        <div class="flex items-center justify-between px-4 py-3 border-b border-slate-100 bg-slate-50">
                            ...
                            <form x-show="unreadCount > 0"
                                  action="<?php echo e(route('notifications.readAll')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
                        ...
                        <div class="max-h-80 overflow-y-auto divide-y divide-slate-50">
                            ...
                            <template x-for="notif in notifications" :key="notif.id">
                                <form :action="`<?php echo e(url('notifications')); ?>/${notif.id}/read`" method="POST">
                                    <?php echo csrf_field(); ?>
                                    <button type="submit"
                        ...
                        <template x-if="notifications.length > 0">
                            <div class="px-4 py-2.5 border-t border-slate-100 bg-slate-50 text-center">
                                <a href="<?php echo e(route('guidance')); ?>"
                                   class="text-xs text-green-600 hover:text-green-800 font-medium transition">
    ...
    <div class="relative max-w-4xl mx-auto px-6 text-center">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
            <p class="mb-6 text-emerald-50/90 text-sm sm:text-base max-w-2xl mx-auto">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isEnrolled()): ?>
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->isEnrolled()): ?>
                    ...
                    <a href="<?php echo e(url('/scholarship')); ?>"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($exam) && $exam): ?>
                    <a href="<?php echo e(route('exam.admission', $exam->id)); ?>"
                       class="inline-flex items-center justify-center gap-2 rounded-xl
...
<section id="features" class="py-24 md:py-32 bg-gradient-to-b from-green-50/80 to-white scroll-mt-20">
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $scholarships; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scholarship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
</html><?php /**PATH /home/u476045238/domains/gvcfiguidancesc.com/public_html/resources/views/welcome.blade.php ENDPATH**/ ?>