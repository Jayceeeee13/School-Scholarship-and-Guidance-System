...
<div style="max-width:740px;margin:0 auto;">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$applicant): ?>
        <div class="card">
    ...
    <div class="card" style="margin-bottom:20px;animation-delay:0.05s;">
        ...
        <div style="padding:20px 32px;border-bottom:1px solid var(--slate-border);display:flex;align-items:center;gap:16px;flex-wrap:wrap;">
            <div style="width:52px;height:52px;border-radius:50%;background:linear-gradient(135deg,#145a32,#1e8449);display:flex;align-items:center;justify-content:center;flex-shrink:0;box-shadow:0 4px 10px rgba(20,90,50,0.25);">
                <span style="color:#fff;font-size:1.1rem;font-weight:700;"><?php echo e($initials); ?></span>
            </div>
            <div>
                ...
                <div style="display:flex;align-items:center;gap:8px;flex-wrap:wrap;">
                    ...
                    <span style="display:inline-flex;align-items:center;background:<?php echo e($sc['bg']); ?>;border:1px solid <?php echo e($sc['border']); ?>;color:<?php echo e($sc['color']); ?>;font-size:0.68rem;font-weight:700;letter-spacing:0.06em;text-transform:uppercase;padding:3px 10px;border-radius:100px;">
        ...
        <div style="padding:18px 32px;display:grid;grid-template-columns:repeat(3,1fr);gap:16px;border-bottom:1px solid var(--slate-border);">
            <div>
                ...
                <p class="info-value"><?php echo e($program); ?> <?php echo e($applicant->year_level); ?></p>
            </div>
            <div>
                <p class="info-label">Gender</p>
                <p class="info-value"><?php echo e($applicant->gender->name ?? 'N/A'); ?></p>
            </div>
            <div>
                <p class="info-label">Contact</p>
                <p class="info-value"><?php echo e($applicant->contact_no ?: '—'); ?></p>
            </div>
        </div>
        ...
        <div style="padding:18px 32px;">
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px;flex-wrap:wrap;gap:8px;">
                ...
                <div style="display:flex;align-items:center;gap:10px;">
                    <span style="font-size:0.75rem;font-weight:700;color:var(--green-mid);">
                        <?php echo e($submittedCount); ?> / <?php echo e($totalReqs); ?> submitted
                    </span>
            ...
            <p style="font-size:0.7rem;color:var(--text-muted);margin-top:6px;">
                <?php echo e($pct); ?>% of your required documents have been submitted.
            </p>
        </div>
    </div>

    
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($requirements->isEmpty()): ?>
        <div class="card">
    ...
    <?php else: ?>
        ...
        <div class="card" style="animation-delay:0.1s;">
            <div class="card-header" style="display:flex;align-items:center;justify-content:space-between;flex-wrap:wrap;gap:12px;">
                <div>
                    <h2 style="font-family:'Playfair Display',serif;font-size:1.1rem;font-weight:700;color:var(--green-deep);margin:0 0 4px;">
                        Requirements for <em><?php echo e($appType); ?></em>
                    </h2>
            ...
            <form method="POST" action="<?php echo e(route('requirements_submission.post')); ?>"
                ...
                <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="file_name"
                               value="<?php echo e(old('file_name', 'GVC_' . strtoupper(substr($applicant->last_name, 0, 6)) . '_' . date('Y'))); ?>"
                               placeholder="e.g. GVC_DELACRUZ_2025"
                               class="field-input <?php echo e($errors->has('file_name') ? 'is-invalid' : ''); ?>">
                        <p class="field-hint">This prefix will be added to all your uploaded file names.</p>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['file_name'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:10px;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php
                            ...
                            <div class="req-row <?php echo e($isDone ? 'is-done' : ''); ?>">
                                
                                <div class="req-row-top">
                                    <div style="display:flex;align-items:center;gap:8px;">
                                        
                                        <span style="width:22px;height:22px;border-radius:50%;background:<?php echo e($isDone ? '#059669' : '#e2e8f0'); ?>;color:<?php echo e($isDone ? '#fff' : 'var(--text-muted)'); ?>;display:inline-flex;align-items:center;justify-content:center;font-size:0.65rem;font-weight:700;flex-shrink:0;">
                                        ...
                                        <p class="req-name"><?php echo e($req->name); ?></p>
                                    </div>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isDone): ?>
                                        <span class="badge badge-done">
                                            <svg width="9" height="9" fill="none" viewBox="0 0 9 9"><circle cx="4.5" cy="4.5" r="4.5" fill="#059669"/><path d="M2.2 4.5l1.6 1.6 2.9-2.9" stroke="#fff" stroke-width="1.1" stroke-linecap="round" stroke-linejoin="round"/></svg>
                ...
                <div style="display:flex;align-items:center;justify-content:space-between;padding-top:12px;border-top:1px solid var(--slate-border);flex-wrap:wrap;gap:12px;">
                    <a href="<?php echo e(url('/scholarship')); ?>" class="btn-back">
                    ...
                    <div style="display:flex;align-items:center;gap:12px;flex-wrap:wrap;">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pendingCount > 0): ?>
                            <span style="font-size:0.78rem;color:var(--text-muted);">
                                <?php echo e($pendingCount); ?> document<?php echo e($pendingCount > 1 ? 's' : ''); ?> still pending
                            </span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
...
</html><?php /**PATH C:\xampp\htdocs\sample\resources\views/requirements_submission.blade.php ENDPATH**/ ?>