...
<?php $component->withAttributes([]); ?>
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasAnyRole(['admin', 'guidance'])): ?>
            <div class="relative overflow-hidden bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <div class="p-4 space-y-1">
                    <a href="<?php echo e(route('filament.admin.resources.support-neededs.index')); ?>"
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.mode-of-counselings.index')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.counseling-time-slots.index')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-blue-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
            ...
            <?php if(auth()->user()->hasAnyRole(['admin', 'scholarship'])): ?>
            <?php
            ...
            <div class="relative overflow-hidden bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <div class="p-4 space-y-1">
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.type-of-applications.index')); ?>"
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.requirements.index')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-green-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.exam-categories.index')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-green-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.periods.index')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-green-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
                        <div class="flex items-center gap-2">
                            <span>Application Period</span>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($appPeriod->is_open): ?>
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.periods.index')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-green-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
                        <div class="flex items-center gap-2">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($examPeriod->is_open): ?>
                                <span class="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold bg-emerald-100 text-emerald-700 border border-emerald-200">
                                    <span class="w-1.5 h-1.5 rounded-full bg-emerald-500 inline-block"></span>
                                    Open
                                </span>
            ...
            <div class="relative overflow-hidden bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow duration-200">
                ...
                <div class="p-4 space-y-1">
                    <a href="<?php echo e(route('filament.admin.resources.departments.index')); ?>"
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.programs.index')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-amber-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
                        <span>Programs</span>
                        <svg class="w-4 h-4 text-gray-400 group-hover:text-amber-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.genders.index')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-amber-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
                        <span>Genders</span>
                        <svg class="w-4 h-4 text-gray-400 group-hover:text-amber-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.school-positions.index')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-amber-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
                    ...
                    <a href="<?php echo e(route('filament.admin.resources.terms.index')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-amber-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
                        <span>Terms</span>
                        <svg class="w-4 h-4 text-gray-400 group-hover:text-amber-500 group-hover:translate-x-1 transition-all" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                    ...
                    <a href="<?php echo e(route('filament.admin.pages.archived-records')); ?>"
                       class="group flex items-center justify-between px-4 py-3 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-amber-50 dark:hover:bg-gray-800 rounded-lg transition-colors">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!auth()->user()->hasAnyRole(['admin', 'guidance', 'scholarship'])): ?>
...
<?php endif; ?><?php /**PATH /home/u476045238/domains/gvcfiguidancesc.com/public_html/resources/views/filament/pages/manage-settings.blade.php ENDPATH**/ ?>