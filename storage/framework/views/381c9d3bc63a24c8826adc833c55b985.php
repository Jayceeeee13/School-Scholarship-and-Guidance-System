        ...
        <div class="fp-inner">
            ...
            <div class="fp-steps">
                <div class="fp-step-item">
                    <div class="fp-step-circle <?php echo e($step === 'email' ? 'active' : 'done'); ?>">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 'email'): ?> 1 <?php else: ?> ✓ <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <div class="fp-step-label <?php echo e($step === 'email' ? 'active' : 'done'); ?>">Email</div>
                </div>
                <div class="fp-step-connector <?php echo e(in_array($step, ['otp','reset']) ? 'done' : ''); ?>"></div>
                <div class="fp-step-item">
                    <div class="fp-step-circle <?php echo e($step === 'otp' ? 'active' : ($step === 'reset' ? 'done' : 'idle')); ?>">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 'reset'): ?> ✓ <?php else: ?> 2 <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                    <div class="fp-step-label <?php echo e($step === 'otp' ? 'active' : ($step === 'reset' ? 'done' : '')); ?>">Verify</div>
                </div>
                <div class="fp-step-connector <?php echo e($step === 'reset' ? 'done' : ''); ?>"></div>
                <div class="fp-step-item">
                    <div class="fp-step-circle <?php echo e($step === 'reset' ? 'active' : 'idle'); ?>">3</div>
                    <div class="fp-step-label <?php echo e($step === 'reset' ? 'active' : ''); ?>">Reset</div>
                </div>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

            
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 'email'): ?>
            ...
            <div class="fp-input-wrap">
                ...
                <input
                    ...
                    class="fp-input <?php echo e($errors->has('email') ? 'error' : ''); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="fp-error-msg">⚠ <?php echo e($message); ?></div>
                <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <a href="<?php echo e(filament()->getLoginUrl()); ?>" class="fp-link">← Back to Sign In</a>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <p class="fp-subtext">
                We sent a 6-digit code to <strong><?php echo e($maskedEmail); ?></strong>. Enter it below to continue.
            </p>
            ...
            <div class="fp-otp-row">
                ...
                <input
                    ...
                    maxlength="1"
                    inputmode="numeric"
                    class="fp-otp-box otp-input <?php echo e($errors->has('otp') ? 'error' : ''); ?>"
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                <div class="fp-error-msg" style="text-align:center;">⚠ <?php echo e($message); ?></div>
            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($step === 'reset'): ?>
            ...
            <div class="fp-input-wrap">
                ...
                <div style="position:relative;">
                    <input
                        ...
                        class="fp-input <?php echo e($errors->has('password') ? 'error' : ''); ?>"
                    >
...
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <div class="fp-error-msg">⚠ <?php echo e($message); ?></div> <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            ...
            <div class="fp-done-wrap">
                ...
                <a href="<?php echo e(filament()->getLoginUrl()); ?>" class="fp-go-btn">
                    Go to Sign In
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    function initOtp() {
        ...
        function updateCombined() {
            ...
            combined.value = val;
            window.Livewire.find('<?php echo e($_instance->getId()); ?>').set('otp', val);
        }
    ...
    document.addEventListener('livewire:initialized', () => {
        window.Livewire.find('<?php echo e($_instance->getId()); ?>').on('otp-sent', () => { startTimer(60); initOtp(); });
    });
...
</div><?php /**PATH /home/u476045238/domains/gvcfiguidancesc.com/public_html/resources/views/livewire/auth/forgot-password.blade.php ENDPATH**/ ?>