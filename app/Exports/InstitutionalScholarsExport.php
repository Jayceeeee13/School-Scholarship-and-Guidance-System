...
class InstitutionalScholarsExport implements FromQuery, WithHeadings, WithMapping, WithStyles, WithColumnWidths
{
    ...
    {
        $query = InstitutionalScholar::query()->orderBy('created_at', 'desc');
