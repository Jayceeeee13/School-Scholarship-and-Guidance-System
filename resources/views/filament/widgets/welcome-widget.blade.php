            ...
            <div class="flex items-center gap-4">
                ...
                @php
                    ...
                    if ($user->hasRole('Admin')) {
                        $avatarColor = 'background: linear-gradient(135deg, #2563eb, #1d4ed8)';
                        $roleLabel = 'Administrator';
                        $roleIcon = '👑';
                        $badgeClass = 'bg-blue-100 text-blue-700 dark:bg-blue-900 dark:text-blue-300';
                    } elseif ($user->hasRole('Scholarship')) {
                        $avatarColor = 'background: linear-gradient(135deg, #059669, #047857)';
                ...
                @else
                    <div
                        style="{{ $avatarColor }}; width: 52px; height: 52px; border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 6px rgba(0,0,0,0.15); flex-shrink: 0;"
                    >
