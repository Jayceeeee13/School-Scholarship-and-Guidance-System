...
<head>
    ...
    <title>Exam Scope – <?php echo e($exam->title ?? 'Admission & Scholarship Test'); ?> | Green Valley College Foundation</title>
...
<header class="bg-green-800 border-b border-white/10 sticky top-0 z-50 shadow-sm">
    <div class="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center gap-4">
        <a href="<?php echo e(url('/gvc')); ?>" class="flex items-center gap-2">
...
<section class="relative overflow-hidden py-12 md:py-16">
    ...
    <div class="relative max-w-3xl mx-auto px-6 text-center">
        ...
        <h1 class="font-display text-3xl sm:text-4xl md:text-5xl font-extrabold leading-tight mb-3 tracking-tight text-emerald-50 drop-shadow-md fade-up d1">
            Scope of the<br>
            <span class="text-gvc-pale"><?php echo e($exam->title ?? 'Admission & Scholarship Test'); ?></span>
        </h1>
        ...
        <div class="inline-flex items-center gap-3 mt-5 bg-emerald-900/50 border border-emerald-400/20 rounded-xl px-5 py-2.5 fade-up d3">
            ...
            <span class="font-display text-xl font-bold text-emerald-300"><?php echo e($totalItems); ?></span>
            <span class="w-px h-4 bg-emerald-600"></span>
            <span class="text-emerald-200 text-xs font-medium">Duration:</span>
            <span class="font-display text-xl font-bold text-emerald-300"><?php echo e($exam->duration_minutes); ?> mins</span>
        </div>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div class="space-y-3 mb-10">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="scope-card bg-white rounded-2xl border border-slate-200 p-5 flex items-start gap-4 fade-up <?php echo e($delays[$index] ?? 'd7'); ?>">
                    <div class="cat-num w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 shadow-sm">
                        <span class="font-display font-bold text-white text-sm">
                            <?php echo e($numerals[$index] ?? ($index + 1)); ?>
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between gap-2 flex-wrap">
                            ...
                            <span class="bg-green-100 text-green-700 text-xs font-bold px-2.5 py-1 rounded-full flex-shrink-0">
                                <?php echo e($category->questions_count); ?> items
                            </span>
                        </div>
        ...
        <div class="bg-white rounded-2xl border border-green-200/60 shadow-sm p-6 fade-up" id="ctaBox">
            ...
            <label class="flex items-start gap-3 cursor-pointer mb-5 group">
                ...
                <span class="text-sm text-slate-600 leading-relaxed group-hover:text-slate-800 transition">
                    ...
                    <strong class="text-slate-800"><?php echo e($exam->title ?? 'Admission and Scholarship Test'); ?></strong>.
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <a href="<?php echo e(route('exam.show', $exam->id)); ?>" id="startBtn"
...
</html><?php /**PATH /home/u476045238/domains/gvcfiguidancesc.com/public_html/resources/views/exam/scope.blade.php ENDPATH**/ ?>