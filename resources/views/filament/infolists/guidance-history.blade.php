...
<div class="space-y-6">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div class="group rounded-2xl border border-primary-100 dark:border-primary-500/20 bg-gradient-to-br from-primary-50 to-white dark:from-primary-500/10 dark:to-transparent p-4 transition-all hover:shadow-md hover:-translate-y-0.5">
        ...
        <div class="group rounded-2xl border border-info-100 dark:border-info-500/20 bg-gradient-to-br from-info-50 to-white dark:from-info-500/10 dark:to-transparent p-4 transition-all hover:shadow-md hover:-translate-y-0.5">
            <div class="flex items-center justify-between">
        ...
        <div class="group rounded-2xl border border-warning-100 dark:border-warning-500/20 bg-gradient-to-br from-warning-50 to-white dark:from-warning-500/10 dark:to-transparent p-4 transition-all hover:shadow-md hover:-translate-y-0.5">
            <div class="flex items-center justify-between">
        ...
        <div class="group rounded-2xl border border-success-100 dark:border-success-500/20 bg-gradient-to-br from-success-50 to-white dark:from-success-500/10 dark:to-transparent p-4 transition-all hover:shadow-md hover:-translate-y-0.5">
            <div class="flex items-center justify-between">
            ...
            <p class="mt-3 text-2xl font-extrabold text-gray-900 dark:text-white leading-none">
                {{ $latest?->counseling_date ? \Carbon\Carbon::parse($latest->counseling_date)->format('M d') : '—' }}
            </p>
